...
std AUC: 0.00070
                   feature  importance
9            LapTime_Delta   22.012511
5                    Stint   21.599973
6                 TyreLife   13.665608
11            RaceProgress   11.698911
4                LapNumber    5.571296
2                     Race    5.418948
12         Position_Change    5.365324
1                 Compound    4.394845
10  Cumulative_Degradation    3.194363
8              LapTime (s)    2.155433
0                   Driver    1.518612
13                LateRace    1.207556
7                 Position    1.189096
3                  PitStop    1.007524
...
def preprocess_data(
    ...
    # 特徴量作成
    X_train_pd_no_year["LateRace"] = (X_train_pd_no_year["RaceProgress"] > 0.8).astype(int)
    X_test_pd["LateRace"] = (X_test_pd["RaceProgress"] > 0.8).astype(int)
