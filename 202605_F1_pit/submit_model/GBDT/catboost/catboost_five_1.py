...
std AUC: 0.00071
                   feature  importance
9            LapTime_Delta   24.580841
5                    Stint   22.126980
6                 TyreLife   12.594653
11            RaceProgress   11.320151
12         Position_Change    5.969169
2                     Race    5.433718
4                LapNumber    4.794138
1                 Compound    4.419187
10  Cumulative_Degradation    2.525880
8              LapTime (s)    2.013240
0                   Driver    1.334202
7                 Position    1.139776
3                  PitStop    1.018116
13  DegradationPerTyreLife    0.729948
...
def preprocess_data(
    ...
    # 特徴量作成
    X_train_pd_no_year["DegradationPerTyreLife"] = (
        X_train_pd_no_year["Cumulative_Degradation"] / X_train_pd_no_year["TyreLife"]
    )

    X_test_pd["DegradationPerTyreLife"] = (
        X_test_pd["Cumulative_Degradation"] / X_test_pd["TyreLife"]
    )
