...
"""
目的
base model(LightGBM)のハイパーパラメータを決める(1回目)

予測精度Score: 0.95734

5-fold-cv
Early stopping, best iteration is:
[905]   valid_0's multi_logloss: 0.0895099
Fold 1: 0.968018
Training until validation scores don't improve for 50 rounds
Early stopping, best iteration is:
[1049]  valid_0's multi_logloss: 0.0875635
Fold 2: 0.968416
Training until validation scores don't improve for 50 rounds
Early stopping, best iteration is:
[1022]  valid_0's multi_logloss: 0.0890006
Fold 3: 0.968442
Training until validation scores don't improve for 50 rounds
Early stopping, best iteration is:
[992]   valid_0's multi_logloss: 0.090132
Fold 4: 0.968156
Training until validation scores don't improve for 50 rounds
Early stopping, best iteration is:
[1011]  valid_0's multi_logloss: 0.0857093
Fold 5: 0.969412
--------------------------------------------------
CV Mean : 0.968489
CV Std  : 0.000546
...
2              u       18145
3              g       16449
13  redshift_g_r       14811
14  redshift_r_i       14634
15  redshift_i_z       14476
12  redshift_u_g       14299
4              r       14182
5              i       13500

分かったこと
- cv が0.22%上昇して，PLBが0.24%上昇したから，ハイパーパラメータが確実に効いている
- Best iteration : 875 より，5000本も木は必要ない -> learning rate = 0.02がちょうどよい
